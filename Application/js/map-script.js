...
function updateMap1 () {
    ...
    if (name == "Select Child") {
      ...
      xmlhttp.open ("GET", "/TrackingSystem/php/map-retrieve.php?name=" + name + "&dur=" + duration, true);
      xmlhttp.send ();
    }
}
...
function showMap1 (position) {
  ...
  xmlhttp.open ("GET", "/TrackingSystem/php/map-retrieve.php?name=&dur=", true);
  xmlhttp.send ();
...
function updateDB (position) {
  ...
  xmlhttp.open ("GET", "/TrackingSystem/php/map-update.php?lat=" + position.coords.latitude + "&lon=" + position.coords.longitude, true);
  xmlhttp.send ();
}
